...
class DC_Catalog_Helper_AttributeInfo extends Mage_Core_Helper_Abstract
{
     ...
     * @return boolean
     */
    public function loadAttributePage(Mage_Core_Controller_Front_Action $action,
        $attributePageId = null, $attribute_code = null, $option_id = null)
    {
     ...
     * @return boolean
     */
    public function loadAllAttributesPage(Mage_Core_Controller_Front_Action $action,
        $attribute_code = null)
    {
